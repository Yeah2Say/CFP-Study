...
馃搳 **Overall Progress**: 60/73 topics covered = **82%**
馃摎 **Study Materials**: 1,088 pages of 2024 Dalton slides
鈴?**Time Remaining**: 3 days 鈿狅笍
馃幆 **Target**: Pass CFP exam November 10, 2025
...
|--------|--------|----------------|------------------|--------|----------|
| **A. Professional Conduct** | 8% | 0/6 | 鉁?90 pages | 鈿?Not Started | Medium |
| **B. General Principles** | 15% | 8/10 | 鉁?90 pages | 馃煛 In Progress (80%) | **HIGH** |
| **C. Insurance & Risk** | 11% | 10/10 | 鉁?188 pages | 馃煝 **COMPLETE (100%)** 鉁?| **DONE** |
| **D. Investment Planning** | 17% | 9/9 | 鉁?188 pages | 馃煝 **COMPLETE (100%)** 鉁?| **DONE** |
| **E. Tax Planning** | 14% | 8/8 | 鉁?150 pages | 馃煝 **COMPLETE (100%)** 鉁?| **DONE** |
| **F. Retirement** | **18%** 猸?| 10/10 | 鉁?182 pages | 馃煝 **COMPLETE (100%)** 鉁?| **DONE** |
| **G. Estate Planning** | 10% | 9/14 | 鉁?200 pages | 馃煛 In Progress (64%) | Medium |
| **H. Psychology** | 7% | 2/6 | 鈿狅笍 Minimal | 馃煛 Started (33%) | Medium |
...
- [ ] **A.1** CFP Board's Code of Ethics and Standards of Conduct
  - **In slides**: 6 Principles, Continuing Ed (30 hrs/2 yrs), Use of CFP庐 marks
...
- [x] **B.8 Financial statements** (2025-11-01) - **High confidence** (PARTIAL)
  - **Fixed vs Variable Cash Outflows** (2025-11-01) - MASTERED:
    - **Fixed Expenses**: Same exact dollar amount every single month
      ...
      - Test: Can you predict the exact $? If YES 鈫?Fixed
    - **Variable Expenses**: Amount changes month to month
      ...
      - Test: Can you predict the exact $? If NO (could be $100 or $300) 鈫?Variable
    - **Key Distinction**: Regular expense 鈮?Fixed expense
    ...
    - Perfect understanding after one explanation 鉁?
...
- [x] **B.9 Cash flow management** (2025-10-20, 2025-10-29, 2025-11-01) - **High confidence**
  ...
  - **Jack problem**: Bond maturing in 3 months = liquid ($44,200 total) 鉁?
  - **What counts**:
  ...
  - **Home Equity Access Methods** (2025-10-29) - MASTERED (with critical analysis):
    ...
    - Selling converts illiquid equity 鈫?liquid cash
  - **In slides**: Pages 45-50

- [x] **B.12 Time value of money** (2025-10-17) - **High confidence**
  - PV/FV calculations: FV = PV 脳 (1 + r)^n
  - Compound interest
...
- [x] **B.10 Financing and debt management** (2025-11-01) - **High confidence**
  - **Financial Ratios - The "28-36 + 3-6-10" Memory System** (2025-11-01) - MASTERED:
    - **Housing Ratio (Front-end)**: Monthly Housing (PITI) 梅 Gross Monthly Income 鈮?**28%**
      - PITI = Principal, Interest, Taxes, Insurance
      - Only housing costs, not other debt
    - **Total Debt Ratio (Back-end)**: Total Monthly Debt 梅 Gross Monthly Income 鈮?**36%**
    ...
    - **Current Ratio**: Current Assets 梅 Current Liabilities 鈮?**1.0** (higher is better)
      - Measures liquidity - can you pay short-term debts?
    - **Savings Ratio**: Annual Savings 梅 Gross Annual Income = **10-12%**
    ...
    - Perfect on practice problem (Sarah & Tom 27% housing, 35% total debt) 鉁?
...
- [x] **B.11 Economic concepts** (2025-10-27) - **Medium confidence** (PARTIAL)
  - **Fiscal Policy** (MASTERED):
    ...
    - **Restrictive/Contractionary fiscal policy**: Increase taxes + Decrease spending
      ...
      - Result: Budget surplus 鈫?Pays down government debt
    - **Expansionary fiscal policy**: Decrease taxes + Increase spending
      - Goal: Stimulate economy
      - Result: Budget deficit 鈫?Increases debt
...
- [x] **B.13 Education needs analysis** (2025-10-27) - **Medium confidence** (PARTIAL)
  ...
  - **Key factors needed**:
    - 鉁?Expected inflation rate (project future costs)
    - 鉁?Time until college begins (time horizon for savings/investments)
    - 鉁?Expected investment returns
  - **What's NOT included**:
    - 鉂?Student's career longevity (happens after college, irrelevant to costs)
    - 鉂?Family's financial aid contribution (too uncertain, separate analysis)
...
- [x] **B.14 Education savings vehicles** (2025-11-01) - **High confidence**
  - **Financial Aid Decision Tree** (2025-11-01) - MASTERED:
    ...
    - **FAFSA Asset Treatment**:
      - Roth IRA (parent): 0% assessment 鉁?BEST for financial aid
      - 529 Plan: 5.64% parent asset (moderate impact)
      - Coverdell ESA: 5.64% parent asset (moderate impact)
      - UGMA/UTMA: 20% STUDENT asset 鉂?WORST (kills aid + child controls at 18-21)
    - **Memory System**: "Aid mentioned? 鈫?Roth wins. Aid not mentioned? 鈫?529 wins."
    - **EXCELLENT pattern recognition** - Student independently identified this pattern! 鉁?
...
- [x] **B.16 Gift/income tax strategies** (2025-11-01) - **High confidence**
  - **AOTC vs LLC** (2025-11-01) - MASTERED:
    ...
    - **Decision Tree**: Undergraduate in first 4 years? 鈫?AOTC (almost always wins with $2,500 max)
    - **Key Exam Traps**:
    ...
    - **EXCELLENT pattern recognition** - Student said "AOTC for undergrad, LLC for postgrad" 鉁?
    - Perfect on practice problem (Jennifer $8K tuition 鈫?AOTC $2,500 vs LLC $1,600) 鉁?
...
### 鉁?Mastered Topics (10/10) - DOMAIN COMPLETE 鉁?
...
- [x] **C.19 Health insurance** (2025-10-15) - **Medium-High confidence**
  ...
  - 鈿狅笍 **Gap resolved 2025-10-18**: Cost calculations now strong
...
- [x] **C.20 Disability income insurance** (2025-10-17, 2025-10-20, 2025-10-21) - **High confidence**
  ...
  - **Group LTD Taxation** (2025-10-20) - MASTERED:
    ...
    - Employer pays premiums 鈫?benefits taxable as ordinary income
...
- [x] **C.21 Long-term care insurance** (2025-10-20, 2025-10-23) - **High confidence**
  ...
  - **Gina problem**: LTC insurance protects $350K estate from depletion 鉁?
  - **Medicaid Waiver Programs** (2025-10-23) - MASTERED:
    ...
    - **Timeline**: Healthy鈫扡TC insurance, Diagnosed鈫扵oo late for insurance鈫扢edicaid Waivers
...
- [x] **C.23 Life insurance** (2025-10-11, 2025-10-20, 2025-10-21) - **High confidence**
  ...
  - **MEC Taxation** (2025-10-20) - MASTERED:
    ...
    - 10% penalty if under 59陆 (in addition to ordinary income tax)
    - Formula: Taxable = LESSER of (loan amount OR total gain)
    - IRC 搂7702A (7-Pay Test)
  ...
  - 鈿狅笍 **Gap**: Types of life insurance details not fully covered
...
- [x] **C.25 Insurance needs analysis** (2025-10-20) - **High confidence**
  ...
  - **$150K earner example**: Needs $1.5M-$2.7M, not $250K 鉁?
...
**Priority**: **COMPLETE** - Insurance domain 100% mastered! 鉁?
...
- [x] **D.27 Investment vehicles** (2025-10-24, 2025-11-01) - **High confidence** (PARTIAL)
  - **Zero-Coupon Bonds** (2025-10-24) - MASTERED:
    ...
    - Calculate implied YTM: FV = PV 脳 (1 + r)^n
    - Perfect on practice problem (10-year bond, Year 2 tax calculation) 鉁?
  - **Treasury Securities** (2025-10-24):
    - T-Bills 鈫?T-Notes 鈫?T-Bonds (shortest to longest maturity)
  - **GNMA (Ginnie Mae) Mortgage-Backed Securities** (2025-11-01) - MASTERED:
    ...
    - **Backed by US government** 鈫?Low default risk 鉁?
    - **The Problem: Prepayment Risk** 鉂?
      - Homeowners can prepay mortgages anytime (refinance, sell, extra payments)
      - When rates drop 鈫?lots of refinancing 鈫?lots of prepayments
      - Investor gets principal back early 鈫?must reinvest at lower rates
    ...
    - Student initially thought GNMA provides fixed income (common trap!) 鉁?
    - Now understands difference between fixed rate vs fixed cash flow 鉁?
...
- [x] **D.28 Types of investment risk** (2025-10-11) - **High confidence**
  ...
  - Formula: Unsystematic risk = 1 - R虏
...
- [x] **D.29 Market cycles** (2025-10-24) - **High confidence** (PARTIAL)
  - **Technical Analysis** (2025-10-24) - MASTERED:
    ...
    - Perfect on practice problem (stock trading $20-$26 range) 鉁?
...
- [x] **D.32 Bond and stock valuation** (2025-10-24) - **High confidence**
  - **Preferred Stock Valuation** (2025-10-24) - MASTERED:
    ...
    - **Formula**: Intrinsic Value = Annual Dividend 梅 Required Return
    - Annual Dividend = Par Value 脳 Dividend Yield
    - Intrinsic value 鈮?Market price
    - Compare to determine if overvalued or undervalued
    - Perfect on practice problem ($35 par, 7% yield, 9% required = $27.22) 鉁?
  ...
  - **Bond Yield Rankings - MASTER PATTERN** (2025-10-24) - MASTERED:
    ...
    - **The Four Yield Measures**:
      - **CR (Coupon Rate)**: Annual Coupon 梅 Par (never changes)
      - **CY (Current Yield)**: Annual Coupon 梅 Current Price
    ...
    - Comprehensive understanding demonstrated 鉁?
  - **Portfolio Immunization** (2025-10-25) - MASTERED:
    ...
    - If rates change, two risks cancel out 鈫?still meet liability 鉁?
    - Perfect on practice problem 鉁?
  - **Modified Duration** (2025-10-25) - MASTERED:
    ...
    - **Price change formula**: % Change = -Modified Duration 脳 螖yield
    - **Critical exam trap**: Must convert Macaulay to Modified before using in formula!
    - Example: Macaulay 10 years, yield 8% 鈫?Modified = 9.26
    - 2% rate increase 鈫?-18.5% price change (NOT -20%!)
    - Student correctly challenged wrong answer 鉁?
  - **Gordon Growth Model with Retention Ratio** (2025-10-25) - MASTERED:
    ...
    - **Growth Rate**: g = ROE 脳 Retention Ratio
    - **Gordon Model**: P鈧� = D鈧?/ (r - g)
    - Example: ROE 12.5%, retention 50% 鈫?g = 6.25%
    - D鈧� $3.50, r 12% 鈫?Intrinsic Value = $64.70 鉁?
  ...
  - **Gordon Growth Model - D0 vs D1 Clarification** (2025-11-01) - Reinforced:
    - **D鈧� = Just paid** (most recent dividend already distributed)
    - **D鈧?= Next dividend** (coming soon, use directly in formula)
    - **When to use which**:
      - Given D鈧� (just paid): Must grow it first 鈫?D鈧?= D鈧� 脳 (1 + g), then use P鈧� = D鈧?/ (r - g)
      - Given D鈧?(next dividend): Use directly 鈫?P鈧� = D鈧?/ (r - g)
    - **Example**: Stock just paid $1.64 (D鈧�), g = 2.25%, r = 7.5%
      - D鈧?= $1.64 脳 1.0225 = $1.6769
      - Intrinsic Value = $1.6769 / (0.075 - 0.0225) = $31.94 鉁?
    - Student practiced this successfully on Mark's stock valuation problem 鉁?
  - **Multi-Stage Dividend Discount Model** (2025-10-25, 2025-11-01) - MASTERED:
    ...
    - **Critical**: Switch growth rate at CORRECT time
      - If D鈧?is last dividend at old rate (2.25%), then D鈧?is first at new rate (2.75%)
      - Formula: D鈧?= D鈧?脳 (1 + new_g) = D鈧?脳 1.0275
    ...
    - **Example Timeline**: ABC stock
      - Today 鈫?Year 3: g = 2.25%
      - Year 4+: g = 2.75% (must switch here!)
    - Multiple practice problems completed with excellent verification 鉁?
...
- [x] **D.30 Quantitative investment concepts** (2025-10-25) - **High confidence** (PARTIAL)
  - **CAPM (Capital Asset Pricing Model)** (2025-10-25) - MASTERED:
    - **Formula**: Required Return = Risk-free Rate + Beta 脳 Market Risk Premium
    ...
    - Example: Beta 1.20, RF 1%, MRP 7% 鈫?Required Return = 9.4% 鉁?
    - Perfect on practice problem 鉁?
  - **Risk-Adjusted Performance Ratios** (2025-10-25, 2025-11-01) - MASTERED:
    ...
    - **Sharpe Ratio** = (Return - Risk-free) / Standard Deviation
      ...
      - Use when: Comparing funds with different risk levels 鉁?
    ...
    - **Alpha** = Actual Return - [RF + Beta 脳 (Market Return - RF)]
      - Measures excess return beyond CAPM prediction
      - Use when: Did manager beat the market?
    - **Decision Tree**: Std dev given 鈫?Sharpe, Beta only 鈫?Treynor, "Beat market" 鈫?Alpha
    - **Clarification (2025-11-01)**: Student initially thought "Sharpe = return per correlation"
      ...
      - Both Sharpe and Treynor measure risk-adjusted returns, just different risk measures 鉁?
    - Perfect on practice problems (Sharpe Ratio) 鉁?
  - **Geometric vs Arithmetic Average** (2025-10-25) - MASTERED:
    - **Visual memory system** (non-English dependent):
      - Arithmetic 馃搹 = STRAIGHT line (add 梅 count)
      - Geometric 馃尡 = GROWTH (compound average)
      - Standard Deviation 馃搳 = SPREAD (NOT an average!)
      - Harmonic 馃殫 = SPEED (for rates, rarely investments)
    ...
    - **Geometric Average**: Shows ACTUAL money growth, accounts for compounding
      - Formula: [(1+r鈧? 脳 (1+r鈧? 脳 ...]^(1/n) - 1
      - Always 鈮?arithmetic (especially with volatility)
      - **Use when**: Multi-period returns (CFP exam default)
    - Example: Returns 12%, -8%, 15%, 5%, 10%
      - Arithmetic: 6.8%
      - Geometric: 6.47% (more accurate) 鉁?
    - Perfect on practice problem 鉁?
...
### 鉁?Mastered Topics (9/9) - DOMAIN COMPLETE 鉁?
...
- [x] **D.31 Asset allocation and portfolio diversification** (2025-10-28) - **Medium confidence** (PARTIAL)
  - **Capital Market Line (CML)** (MASTERED):
    ...
    - **Application**: Want 10% risk 鈫?E(Rp) = 2% + 0.533 脳 10% = 7.33% return
    - **Portfolio mix**: Combine percentages of T-Bills and market portfolio to achieve target risk
    - Perfect conceptual understanding, needs practice problems 鉁?
...
**Priority**: **INVESTMENT PLANNING DOMAIN 100% COMPLETE!** 鉁?(17% of exam - second highest weighted domain mastered!)
...
- [x] **E.36 Tax law fundamentals** (2025-10-11, 2025-10-25, 2025-11-01, 2025-11-02) - **High confidence**
  ...
  - **Alternative Minimum Tax (AMT) - Property Tax Treatment** (2025-11-02) - MASTERED:
    - **Property Taxes and AMT**:
      ...
      - AMT: State/local taxes NOT deductible (add-back item under IRC 搂56(b)(1)(A)(ii))
    - **The Trap**: Prepaying property taxes when IN AMT
      ...
      - Result: Prepaying creates ADD-BACK 鈫?INCREASES AMTI exposure 鉂?
    - **Why NQSOs Increase AMT More Than Property Tax Prepayment**:
      ...
      - NQSOs = Large income increase 鈫?Largest AMT increase 鉁?
    - **The AMT Add-Backs to Know** (IRC 搂56, 搂57):
      - 鉁?State/local income taxes (SALT)
      - 鉁?Property taxes
      - 鉁?Miscellaneous itemized deductions (pre-TCJA)
      - 鉁?ISO spread (incentive stock options - big one!)
      - 鉂?Charitable contributions (NOT added back)
      - 鉂?Mortgage interest on primary residence (NOT added back)
    ...
    - Student initially selected prepaying property taxes thinking it helps avoid AMT 鉁?
    - Now understands: Property taxes NOT deductible for AMT, prepaying increases exposure 鉁?
  - **Divorced Parent Dependency Rules - IRC 搂152(e)** (2025-11-01) - MASTERED:
    ...
    - **Example**: Ruth (custodial parent) vs Doug (provides 75% support, $15K/year)
      - No Form 8332 written agreement 鈫?Ruth claims both children 鉁?
      - Doug's higher support doesn't matter under IRC 搂152(e)
  ...
  - **Municipal Bond Taxation** (2025-10-25) - MASTERED:
    ...
    - This distinction critical for capital loss offset strategies 鉁?
...
- [x] **E.37 Income tax calculations** (2025-10-11, 2025-10-19, 2025-10-24, 2025-11-02) - **High confidence**
  ...
  - **Kiddie Tax (IRC 搂1(g)) and UGMA/UTMA** (2025-11-02) - MASTERED:
    - **UGMA/UTMA Basics**:
      ...
      - Child's SSN used
    - **Kiddie Tax (IRC 搂1(g))** applies to:
    ...
    - **2024 Kiddie Tax Thresholds**:
      ...
      - **Amount over $2,600**: Taxed at PARENT'S marginal rate 鉁?
    ...
    - **Example - Fred & Sarah** (2025-11-02):
      ...
      - Total tax: $130 + $576 = $706 鉁?
    - **Why Kiddie Tax Exists** (Policy):
      - Pre-1986: Parents gifted assets to kids 鈫?income taxed at kid's low rate (tax avoidance)
    ...
    - **UGMA vs Trust**:
      ...
      - Student initially confused UGMA with trust 鉁?
    - **FAFSA Impact**:
      - UGMA/UTMA = Child asset 鈫?20% assessment rate
      - Parent asset 鈫?5.64% assessment rate
      - $10,000 in UGMA 鈫?Reduces aid by $2,000/year
    - **Memory System**:
  ...
  - **Estimated tax safe harbor rules** (2025-10-19) - MASTERED:
    - 100% prior year if AGI 鈮?$150K, 110% if > $150K
    - OR 90% of current year
    - Use LESSER amount to avoid penalty
    - Perfect on lottery winnings problem 鉁?
  - **OID (Original Issue Discount) Taxation - Zero-Coupon Bonds** (2025-10-24) - MASTERED:
    ...
    - Calculate implied YTM first: FV = PV 脳 (1 + r)^n
    - Each year: Taxable interest = Beginning value 脳 YTM
    - Taxable amount increases each year (compound growth)
    - **Phantom income**: Pay tax on money not received
    - Example: $445 bond 鈫?$1,000 in 10 years at 8.41% YTM
      - Year 1: $445 脳 8.41% = $37.42 tax
      - Year 2: $482.42 脳 8.41% = $40.57 tax
    - Common trap: Straight-line would be ($1,000 - $445) 梅 10 = $55.50 (WRONG!)
    - Perfect on practice problem (Year 2 taxable interest calculation) 鉁?
...
- [x] **E.38 Business entity taxation** (2025-10-11, 2025-10-28, 2025-11-01, 2025-11-02) - **Medium-High confidence** (PARTIAL)
  - **C Corporation Distributions** (2025-10-28) - MASTERED:
    ...
    - **Critical Distinction**: E&P 鈮?Cash Available
    ...
    - Student asked EXCELLENT question: "How can company distribute $70K with only $50K E&P?" 鉁?
    - Perfect understanding of waterfall mechanics 鉁?
  - **Section 1221 vs Section 1231 Property** (2025-11-01) - MASTERED:
    - **IRC 搂1221 - Definition of Capital Asset** (what IS a capital asset):
      - **Rule**: Everything is a capital asset EXCEPT what 搂1221 specifically excludes
      - **What 搂1221 EXCLUDES** (NOT capital assets):
      ...
      - **Memory Aid**: "搂1221 Says NO" (defines what's NOT a capital asset)
    - **IRC 搂1231 - Special Business Property Treatment** (what GETS preferential treatment):
      - **What 搂1231 INCLUDES** (gets special tax treatment):
      ...
      - **The Magic**: If 搂1231 property sold:
        - **Net gain** 鈫?Taxed as LONG-TERM CAPITAL GAIN (15-20%, favorable!)
        - **Net loss** 鈫?Deducted as ORDINARY LOSS (against ordinary income, better!)
        - "Best of both worlds" - gain = capital, loss = ordinary
      - **Memory Aid**: "搂1231 Says GO" (special treatment that helps you "go" = benefit)
    - **The Relationship Between 搂1221 and 搂1231**:
      - 搂1221 says business property is NOT a capital asset (excluded)
      - 搂1231 says "even though it's not capital, we'll treat GAINS like capital anyway"
      - **Example**: Business building (depreciable real estate)
        - 搂1221: NOT a capital asset (excluded from definition)
        - 搂1231: Gets capital gain treatment anyway (if net 搂1231 gain)
        - Student: "So it's kind of like an exception to the exception?" 鈫?YES! Exactly! 鉁?
    - **Lisa's Business Assets Example** (2025-11-01):
      - Warehouse (depreciable real estate) 鈫?搂1231 property 鉁?
      - Machinery (depreciable equipment) 鈫?搂1231 property 鉁?
      - Inventory 鈫?NOT 搂1231 (it's ordinary property)
      - **Rule**: 搂1231 = depreciable business property + business real estate (held >1 year)
    - Perfect understanding of distinction and interaction 鉁?
  - **Depreciation vs Amortization** (2025-11-02) - MASTERED:
    - **Key Distinction**: DIFFERENT tax methods for DIFFERENT asset types
    - **Depreciation (IRC 搂167, 搂168 MACRS)**:
    ...
    - **Baxter's Assets Categorized** (2025-11-02):
      - Trademark & Copyright: INTANGIBLE 鈫?鉁?AMORTIZABLE (IRC 搂197, 15 years)
      - Office Building: TANGIBLE 鈫?DEPRECIABLE (39-year MACRS), NOT amortizable
      - Computers: TANGIBLE 鈫?DEPRECIABLE (5-year MACRS), NOT amortizable
      - Land: NEVER depreciable or amortizable (doesn't wear out)
    - **The Rule**: Can you TOUCH it? 鈫?Depreciate. Can't touch it (idea/right)? 鈫?Amortize
    - **Why Different Terms?**:
      - Both recover cost over time (same goal)
      - But different tax rules based on asset type
      - Tangible wears out physically 鈫?depreciation rules
      - Intangible has legal/economic life 鈫?amortization rules
      - NOT interchangeable terms!
    - **Memory System**: "D.A.T.I. Rule"
      - **D**epreciation for **T**angible
      - **A**mortization for **I**ntangible
    - **Drop Test**: "If you can DROP IT on your foot 鈫?DEPRECIATE. If you can't DROP IT (not physical) 鈫?AMORTIZE"
    - Student initially confused office building (thought amortizable) 鉁?
    - Now understands: Buildings = tangible = depreciable, NOT amortizable 鉁?
    - Perfect clarity on distinction 鉁?
...
- [x] **E.40 Tax reduction techniques** (2025-10-11, 2025-10-19, 2025-10-25, 2025-11-02) - **High confidence**
  ...
  - **Bad Debt Deduction Requirements (IRC 搂166)** (2025-11-02) - MASTERED:
    ...
    - **The Contingent Repayment Problem**:
      - "Pay me back IF business succeeds" = NOT legal obligation 鉂?
      - "Pay me back IF I get inheritance" = NOT legal obligation 鉂?
      - IRS views contingent repayment as part gift, part loan
      - If business fails 鈫?Borrower had NO obligation 鈫?NOT deductible
    - **The Family Loan Problem**:
      ...
      - No written agreement + family relationship = presumed gift 鉂?
    - **Example - Mother-Daughter Loan** (2025-11-02):
      ...
      - NOT deductible if becomes worthless 鉂?
    - **Example - Friend Loan with Written Agreement** (2025-11-02):
      - $20,000 for investment, written agreement + interest charged
      - PASSES all tests:
        - Written agreement = bona fide debt 鉁?
        - Interest charged = economic substance (not gift) 鉁?
        - Unconditional repayment = legal obligation 鉁?
      - If worthless 鈫?Deductible as short-term capital loss ($3K/year limit) 鉁?
    - **Tax Treatment if Deductible**:
      - Non-business bad debt 鈫?SHORT-TERM CAPITAL LOSS (regardless of how long held)
      - Limited to $3,000/year against ordinary income
      - Excess carries forward indefinitely
      - Example: $20K bad debt 鈫?Year 1: -$3K, Year 2: -$3K, etc.
    - **Memory System**:
    ...
    - Student initially selected contingent mother-daughter loan 鉁?
    - Now understands: Contingent repayment = NOT deductible 鉁?
  - **Tax credits vs tax deductions** (2025-10-19) - MASTERED:
    - Tax credit = dollar-for-dollar reduction ($355 credit = $355 savings)
    - Tax deduction = reduces taxable income (value 脳 marginal rate)
    - $1,000 deduction in 32% bracket = only $320 savings
    - Credits ALWAYS beat equal-dollar deductions 鉁?
  ...
  - **Capital Loss Carryover** (2025-10-25) - MASTERED:
    ...
    - **Critical tax treatments**:
      ...
      - Municipal bond sold at premium = **CAPITAL GAIN** (taxable!) 鉁?
    - **Only capital gains can offset capital loss carryover**
    - Student's excellent reasoning: "B definitely gives you more" 鉁?
    - Perfect on practice problem 鉁?
...
- [x] **E.41 Property transactions** (2025-10-18, 2025-10-28, 2025-11-02) - **High confidence**
  ...
  - **Vacation Rental Expense Allocation (IRC 搂280A)** (2025-11-02) - MASTERED:
    - **Classification Test** (determines if property qualifies as rental):
      - Rented 鈮?15 days AND Personal use 鈮?14 days OR 鈮?10% of rental days 鈫?**Rental Property**
      - Can deduct expenses (subject to allocation formula)
    - **Expense Allocation Formula**:
      - Deductible % = Rental Days 梅 (Rental Days + Personal Days)
    ...
    - **Brenda's Example** (2025-11-02):
      ...
      - Classification: 10 days < 14 AND < 35.5 (10% 脳 355) 鈫?Qualifies as rental 鉁?
      - Deductible %: 355 梅 (355 + 10) = 97.26%
      - Deduction: $5,000 脳 97.26% = $4,863 鉁?
    - **Student's BRILLIANT Question** (2025-11-02):
      ...
      - **Answer: YES!** If vacant instead of personal use:
        ...
        - Deductible % = 355 梅 (355 + 0) = 100%
        - Full $5,000 deduction 鉁?
      - **Why**: Vacant days = property held for rental but temporarily unoccupied
        - No personal benefit from vacant days 鈫?no reduction in deduction
    ...
    - Student demonstrated exceptional critical thinking identifying vacant vs personal use distinction 鉁?
  - **1031 Like-Kind Exchanges** - EXCELLENT:
    - Boot = Cash received + Debt relief not replaced 鉁?
    - Balanced equation: What you give up = What you get 鉁?
    - Basis formula: Old basis - Boot + Gain recognized 鉁?
    - Perfect on practice problem ($300K boot) 鉁?
  - **Section 1245 vs Section 1250 Depreciation Recapture** (2025-10-28) - MASTERED:
    ...
    - **Installment Sale Mechanics**:
      - **Gross profit %** = (Sale price - Adjusted basis) 梅 Contract price
      - Apply % to each payment to determine gain recognized
      - Example: $250K sale, $30K basis 鈫?$220K gain 梅 $250K = 88% gross profit %
      - 20% down payment ($50K) 脳 88% = $44K gain in Year 1 鉁?
    ...
    - Student validated in frustration about tax complexity 鉁?
...
- [x] **E.43 Charitable contributions** (2025-10-11, 2025-10-19, 2025-11-02) - **High confidence**
  ...
  - **Related use rule for tangible personal property** (2025-10-19) - MASTERED:
    ...
    - Antique vase problem: Charity sold it = deduct $1,700 basis only 鉁?
    - Prevents deducting gains charity actually received 鉁?
  - **Pooled Income Fund** (2025-11-02) - MASTERED:
    ...
    - **CRITICAL RESTRICTION: Cannot invest in tax-free municipal bonds** 鉂?
...
- [x] **E.39 Trusts and estates taxation** (2025-10-19) - **High confidence**
  ...
  - **Estate income tax problem**: Dividends from stocks must be reported 鉁?
...
**Priority**: **TAX PLANNING DOMAIN COMPLETE!** 鉁?Only E.42 remaining (low priority)

---

## F. Retirement Savings and Income Planning (18%) 猸?HIGHEST WEIGHT

**Slides**: Retirement (182 pages - MOST COMPREHENSIVE)

### 鉁?Mastered Topics (9/10)
...
- [x] **F.45 Social Security and Medicare** - **High confidence**
  ...
  **Social Security** (2025-10-16, 2025-10-21, 2025-10-29):
  ...
  - **Spousal Benefits with Early Filing** (2025-10-21) - MASTERED:
    ...
    - Example: PIA $1,500, spouse PIA $3,600 鈫?Total $1,680 ($1,400 own + $275 spousal)
  - **Fully Insured vs Currently Insured Status** (2025-10-29) - MASTERED:
    ...
    - **Work history gaps**:
      ...
      - Example: 4 years work, 4 years grad school, 1 year work = 16 total credits (fully 鉁? but only 4 recent (currently 鉁?
    - **Why two statuses exist**: Currently insured protects young workers who die before earning enough lifetime credits
    - Student noted: "This is tricky" - accurate assessment! 鉁?
  - **In slides**: Pages 165-175
  - 鈿狅笍 **Minor gap**: Early filing reduction % (thinks 5%, actually 5/9 then 5/12) - being resolved

  **Medicare** (comprehensive deep dive 2025-10-18):
  - All Parts A/B/C/D details mastered
  - MA vs Medigap tradeoffs understood
  - Enrollment periods, commissions, coverage limits 鉁?
  ...
  - **Target Benefit Plans** (2025-11-01) - MASTERED:
    ...
    - **Key Concept: Age-Weighting Favors Older Employees**
      - Example targeting $50K/year at age 65:
        ...
        - Age 55 (10 years left): $40,000/year contribution (40% of salary) 鉁?
      - Less time to accumulate 鈫?need larger contributions
    ...
    - Student initially thought it favored young employees (common trap!) 鉁?
    - Now understands age-weighting concept perfectly 鉁?
  - **Retirement Plan Selection Patterns** (2025-10-23) - MASTERED:
    - **"Flexible contributions"** 鈫?Rules out DB plans (actuarially required)
    - **"Employee retention"** 鈫?Need vesting schedules (rules out SEP, SIMPLE)
    - **"Maximize owner contributions"** 鈫?DB plans or high DC limits
...
- [x] **F.48 Qualified plan rules** (2025-10-11, 2025-10-20, 2025-10-23, 2025-10-29, 2025-11-02) - **High confidence**
  ...
  - **Social Security Integration - Plans That CANNOT Integrate** (2025-11-02) - MASTERED:
    ...
    - **Plans That CAN Integrate**:
      - 鉁?Profit-sharing plans (the correct answer!)
      - 鉁?Traditional pension plans (defined benefit)
      - 鉁?Money purchase plans
      - 鉁?401(k) plans
      - 鉁?Target benefit plans
    ...
    - Student initially selected SIMPLE IRA thinking it would integrate 鉁?
    - Now understands: SSE = the three plans that cannot integrate 鉁?
  - **Nondiscrimination Coverage Testing (IRC 搂410(b))** (2025-10-29) - MASTERED:
    - **Purpose**: Ensure plans don't only benefit highly paid employees
    - **Two tests available**:
      - **Ratio Percentage Test**: (% NHCEs benefitting) 梅 (% HCEs benefitting) 鈮?70%
        - Example: 90% HCEs participate 鈫?need 63% NHCEs minimum (70% 脳 90%)
      - **Average Benefits Test**: (Avg benefit % NHCEs) 梅 (Avg benefit % HCEs) 鈮?70%
        - Example: HCEs get 12% of comp 鈫?NHCEs need 8.4% minimum (70% 脳 12%)
    - **CRITICAL DIRECTION**: Protected group (NHCEs) must be 70% of advantaged group (HCEs)
      - **NEVER backwards!** Not HCE 梅 NHCE (would protect bosses, not workers)
      - Formula pattern: NHCE amount 梅 HCE amount 鈮?70%
  ...
  - **Vesting as Retention Tool** (2025-10-23):
    ...
    - **Key pattern**: "Employee retention" objective 鈫?need vesting schedules
...
- [x] **F.51 Distribution rules** (2025-10-17, 2025-10-23, 2025-11-01) - **High confidence**
  ...
  - RMD calculation: Balance (12/31 prior) 梅 Life expectancy (age 12/31 current)
  - Perfect calculation: $500K 梅 26.5 = $18,868 鉁?
  ...
  - **Early Withdrawal Penalty Exceptions** (2025-10-23, 2025-11-02) - MASTERED:
    - **CRITICAL #1 EXAM TRAP: HARDSHIP 鈮?EXCEPTION!** (2025-11-02):
      - **Most common mistake**: Thinking hardship withdrawals avoid 10% penalty
      - **Reality**: Hardship withdrawals STILL subject to 10% penalty (if under 59陆)!
    ...
    - **The Main Exceptions - "D鲁 + 55 = FREE"** (2025-11-02):
      - **D鹿 = DEATH**: Beneficiary receives after participant dies (no penalty)
      - **D虏 = DISABILITY**: Totally and permanently disabled (no penalty)
      - **D鲁 = Distributions after 59陆**: Magic age (no penalty)
    ...
    - **Rule of 55 CRITICAL Requirement** (2025-10-23, 2025-11-02):
      ...
      - Example: Age 55, in-service hardship = PENALTY applies 鉂?
      - Example: Age 55, QUIT job, take distribution = NO penalty 鉁?
      - **Memory**: "Rule of 55: You must QUIT (separate), not just hit 55"
      - **Memory**: "In-Service = In-Penalty" (if under 59陆 and not disabled)
    ...
    - Perfect on practice problems (Rule of 55, QDRO, IRA education exception) 鉁?
  - **401(k) Hardship Withdrawals vs In-Service Rollovers** (2025-11-01) - MASTERED:
    - **Hardship Withdrawal Requirements**:
      ...
      - Tax treatment: Ordinary income + 10% penalty (if under 59陆)
    ...
    - **Why Hardship Withdrawal Exists** (vs regular withdrawal):
      - Many 401(k) plans DON'T allow regular in-service withdrawals before age 59陆
    ...
    - **Student's Excellent Alternative Question**: "Why not rollover to IRA first, then withdraw?"
      - **CRITICAL RESTRICTION**: In-service rollovers generally NOT allowed before age 59陆
      - Can't rollover WHILE still employed at that company (except specific circumstances)
      - **Exception**: Some plans allow in-service rollovers after age 59陆
      - **Result**: For Joe (age 48), rollover NOT an option 鈫?Hardship withdrawal is only choice
    - **Why This Is Important**:
      - Student demonstrated EXCELLENT professional skepticism 鉁?
    ...
    - **Joe's Mortgage Problem** (2025-11-01):
      ...
      - Can't do regular withdrawal (plan doesn't allow in-service before 59陆)
      - Can't rollover to IRA (in-service rollover restricted before 59陆)
      - **ONLY option**: Hardship withdrawal (prevents foreclosure = qualifies)
      - Takes withdrawal, pays tax + 10% penalty, keeps house 鉁?
    - Student challenged instructor twice with excellent questions - shows deep thinking! 鉁?
  - **In slides**: Pages 80-100
  - 鈿狅笍 **Remaining gap**: 72(t) SEPP calculations not yet covered
...
- [x] **F.53 Business succession planning** (2025-10-21, 2025-10-23) - **High confidence**
  ...
  - **Buy-Sell Agreement Components** (2025-10-23) - MASTERED:
    - **MUST HAVE - Core elements**:
      ...
      - **Valuation method** (prevents disputes over price) 鈫?CRUCIAL
    ...
    - **SHOULD HAVE - Family protection**:
      - **Trust establishment** (manages transaction, protects family) 鈫?CRUCIAL
    ...
    - **NOT IN BUY-SELL AGREEMENT** (common trap):
      - 鉂?Roles and responsibilities (goes in operating agreement)
      - 鉂?Job descriptions (employment contracts)
      - 鉂?Management succession plan (separate document)
      - 鉂?CEO transition timeline (succession roadmap)
      - **Key distinction**: Buy-sell = OWNERSHIP transfer, NOT management structure
    - **AVOID**:
      - 鉂?Asset exclusions (creates ambiguity and future disputes)
      - Keep agreement comprehensive and clear
    - Perfect on practice problem (valuation + trust, not roles) 鉁?
...
- [x] **F.49 Non-qualified plan rules** (2025-10-23, 2025-10-31) - **Medium-High confidence** 猸?(PARTIAL)
  - **Traditional IRA Deductibility Phase-Outs** (2025-10-23) - MASTERED:
    - **Three different phase-out ranges** (critical to memorize):
      ...
      - **Non-Active Participant (spouse is active) - MFJ**: $230K - $240K (2024) 鈫?Much higher!
    ...
    - Perfect on practice problem (Sarah $225K MAGI, full $7K deduction) 鉁?
...
**Priority**: **RETIREMENT DOMAIN 100% COMPLETE!** 鉁?(18% of exam - highest weighted domain mastered!)
...
- [x] **G.54 Property titling** (2025-10-11, 2025-10-19, 2025-11-02) - **High confidence**
  ...
  - **JTWROS vs Tenancy in Common** (2025-11-02) - MASTERED:
    - **#1 Rule of JTWROS**: CANNOT pass by will (bypasses will entirely!)
      ...
      - When joint tenant dies 鈫?Share evaporates, survivor owns 100%
      - Will cannot override this (JTWROS trumps will)
    - **Why Other Statements Are TRUE**:
      - 2+ tenants, may/may not be related 鉁?(same as TIC)
      - **Ownership must be equal** 鉁?(This IS required for JTWROS!)
      - Passes to surviving owners 鉁?(Definition of survivorship)
    ...
    - Student thought "ownership must be equal" was wrong answer 鉁?
    - Now understands: JTWROS CANNOT pass by will (that's the false statement) 鉁?
  - **Ancillary Probate** (2025-11-02) - MASTERED:
    ...
    - **Why It's a Nightmare**:
      - Pay for probate in BOTH states (2脳 attorney fees, court fees)
    ...
    - **Memory System**:
      ...
      - "The THREE A's": ANCILLARY probate 鈫?Lifetime transfer
    - Student initially didn't select lifetime transfer recommendation 鉁?
    - Now understands: Out-of-state property = ancillary probate problem 鉁?
  - **JTWROS Estate Tax Treatment** (2025-10-19) - MASTERED:
    - Included in gross estate for estate tax (IRC 搂 2040) 鉁?
    - 50% included for spouses, 100% for non-spouses (unless prove contribution)
    - Avoids PROBATE but NOT estate tax 鉁?
    - Common trap: "avoids probate" 鈮?"avoids estate tax"
  - **Step-Up Basis Rules**:
...
- [x] **G.55 Strategies to transfer property** (2025-10-21, 2025-10-31) - **High confidence**
  ...
  - **SCIN vs Other Gift Tax Avoidance Methods** (2025-10-31) - MASTERED:
    ...
    - **All other common methods create GIFTS**:
      ...
      - **FLP with gifts**: Only $18K annual exclusion applies, excess is taxable gift
        ...
        - With exhausted credit 鈫?immediate gift tax liability
  ...
  - **GRIT limitations**: Doesn't work for family members (IRC 搂2702)
...
- [x] **G.57 Gift, estate, and GST tax compliance and calculation** (2025-10-21, 2025-11-01, 2025-11-02) - **High confidence**
  - **Overqualification and Portability** (2025-11-02) - MASTERED:
    ...
    - **Portability (DSUE - Deceased Spousal Unused Exclusion)**:
      ...
      - Example: Husband dies with $5M unused 鈫?Wife gets $5M DSUE
    ...
    - Student challenged overqualification concept with portability question 鉁?
    - Now understands: Portability doesn't protect growth, overqualification still wastes benefit 鉁?
  - **Annual Exclusion Gifting** - MASTERED:
    ...
    - Example: 2 parents 脳 4 recipients 脳 $17K = $136K annual gifts
  ...
  - **Gift Valuation and Tax Calculation** (2025-11-01) - MASTERED:
    ...
    - Example: $5,130,000 gift - $18K = $5,112,000 taxable 鈫?no tax due (covered by credit)
  - **Loss Property Gifts and Double-Basis Rule** (2025-11-01) - MASTERED:
    ...
    - **Gift tax can ONLY be added to basis for APPRECIATED property**
      - Appreciated (FMV > Basis): Gift tax CAN be allocated to increase basis 鉁?
      - Loss property (FMV < Basis): Gift tax CANNOT be allocated 鉂?
    - **Double-Basis Rule for Loss Property**:
      ...
      - **Sale scenarios**:
        - Sell above donor's basis 鈫?Use gain basis (donor's original basis)
        - Sell below FMV at gift 鈫?Use loss basis (FMV at gift)
        - **Sell between the two bases 鈫?NO gain or loss** (the "dead zone")
    - **Example**: Basis $6.8M, FMV $5.13M at gift
      - Sell for $7M 鈫?Gain = $200K (use $6.8M basis)
      - Sell for $6.5M 鈫?NO gain or loss (in dead zone)
      - Sell for $5M 鈫?Loss = $130K (use $5.13M basis)
  ...
  - **Gross Estate Calculation** - MASTERED:
    - **3-Year Lookback Rule (IRC 搂2035)**:
      - Life insurance transferred within 3 years of death 鈫?included in estate
    ...
    - **JTWROS Estate Tax Treatment (IRC 搂2040)**:
...
- [x] **G.59 Types, features, and taxation of trusts** (2025-10-20 voice, 2025-10-21, 2025-11-01) - **High confidence**
  ...
  - **QPRT (Qualified Personal Residence Trust)** (2025-10-21) - MASTERED:
    ...
    - **AFR effect**: Higher AFR 鈫?Lower PV of retained interest
    - **Term length effect**: Shorter term 鈫?Higher gift (less retained interest)
  ...
  - **Memory Aid Created**: CRAT/CRUT 鈫?Charity Remainder, GRAT/GRUT 鈫?Grantor Retained
  - **CRT 4-Tier Taxation** (2025-10-21) - MASTERED:
    ...
    - Preserves character of income (prevents ordinary鈫抍apital conversion)
  - **Irrevocable Trust Estate Tax & Income Tax** (2025-10-21) - MASTERED:
    ...
    - **DNI (Distributable Net Income) Rules**:
      - Income distributed 鈫?beneficiaries pay income tax
      - Income retained 鈫?trust pays income tax (at higher rates)
  ...
  - **IRC 搂678 - Beneficiary as Owner for Tax Purposes** (2025-11-01) - MASTERED:
    - **"Power = Ownership" Rule**: If beneficiary has power to withdraw trust assets but chooses not to 鈫?treated as owner for income tax
  ...
  - **搂2503(c) Trusts - Minor's Trust** (2025-11-01) - MASTERED:
    ...
    - **Tax consequence when beneficiary doesn't revoke**:
      ...
      - Why? Has power to withdraw 鈫?IRC 搂678 applies 鈫?treated as owner
  ...
  - **Crummey Powers - Gift Tax vs Income Tax Purposes** (2025-11-01) - MASTERED:
    ...
    - **Answer**: Life insurance cash value growth = TAX-DEFERRED (IRC 搂7702)
    - **Key Distinction**:
      - **搂2503(c) trust with stocks/bonds**: Generates dividends, interest, capital gains = LOTS of taxable income
        - Beneficiary with withdrawal power 鈫?pays tax on all that income
      - **ILIT with life insurance**: Cash value grows tax-deferred 鈫?minimal/zero taxable income
    ...
    - **Crummey Letters**: Notify beneficiaries of 30-60 day withdrawal window
      - Beneficiaries don't withdraw 鈫?premium gets paid
      - Gift qualifies for annual exclusion (present interest)
    - **Life insurance tax benefits**:
      - Cash value growth = tax-deferred (IRC 搂7702)
      - Not taxable until policy surrendered
      - ILIT holds to death 鈫?never surrendered 鈫?never income taxed
      - Death benefit = income tax-free (IRC 搂101(a))
    - **Student demonstrated exceptional cross-domain thinking** 鉁?
  - **IRC 搂677(b) - Support Obligation Rule** (2025-11-02) - MASTERED:
    - **The Rule**: When trust income is used to discharge grantor's legal support obligation 鈫?Grantor taxed on that portion
    ...
    - **Who Has Legal Support Obligation?**:
      - 鉁?Minor children (under 18)
      - 鉁?Spouse (during marriage)
      - 鉂?Adult children (generally no obligation after 18)
      - 鉂?Grandchildren (no legal obligation)
      - 鉂?Nieces/nephews (no legal obligation)
    ...
    - **Tax Allocation**:
      - Portion used for support 鈫?Grantor taxed (discharges obligation = grantor benefit)
      - Portion NOT used for support 鈫?Trust taxed (no grantor benefit)
      - Total: 100% of income taxed (someone pays on all of it)
    - **If Facts Changed**:
      - If child is adult (25): No legal obligation 鈫?Maxwell pays $0, Trust or beneficiary pays 100%
      - If trust for grandson: No legal obligation 鈫?Maxwell pays $0
      - If trust for ex-spouse (alimony): Discharges alimony obligation 鈫?Maxwell taxed
    - **Different from IRC 搂678** (yesterday's Julie case):
      - 搂678: Beneficiary with withdrawal POWER 鈫?Beneficiary taxed ("Power = Ownership")
      - 搂677(b): Trust income discharges grantor's obligation 鈫?Grantor taxed ("Benefit = Income")
    ...
    - Student initially thought irrevocable trust = trust pays all tax (logical but incorrect) 鉁?
    - Now understands indirect benefit to grantor creates tax liability 鉁?
  - **Memory Systems**:
...
- [x] **H.66 Behavioral finance** (2025-10-20) - **High confidence**
  - **Herd Mentality**: Following crowd even when you disagree
    ...
    - Example: Client disagrees with forum consensus but goes along anyway 鉁?
...
- [x] **H.67 Sources of money conflict** (2025-10-20) - **High confidence**
  ...
  - **Power Imbalance from Income Disparity**:
    - One partner earns significantly more 鈫?creates control dynamics
...
- **Status**: PARTIALLY RESOLVED (2025-10-28, 2025-11-01)
  - 鉁?C Corporation distributions - MASTERED (2025-10-28)
  - 鉁?Section 1221 vs 1231 property - MASTERED (2025-11-01)
  - 鉂?Section 179 expensing - Still needs work
  - 鉂?MACRS depreciation - Still needs work
  - 鉂?Mid-quarter convention - Still needs work
...
- **Partial resolutions**:
  ...
  - 2025-11-01: Section 1221 vs 1231 mastered (capital asset definition and 搂1231 special treatment)

### 馃煛 MEDIUM SEVERITY

**2. F.51 Early Withdrawal Exceptions & 72(t)**
- **Status**: SUBSTANTIALLY RESOLVED (2025-11-01)
  - 鉁?Rule of 55 - MASTERED (2025-10-23)
  - 鉁?QDRO exceptions - MASTERED (2025-10-23)
  - 鉁?IRA vs 401(k) exception differences - MASTERED (2025-10-23)
  - 鉁?"HIDES" mnemonic - MASTERED (2025-10-23)
  - 鉁?Hardship withdrawals & in-service rollover restrictions - MASTERED (2025-11-01)
  - 鉂?72(t) SEPP calculations - Still needs work
...
- **Now**: HIGH confidence - perfect understanding of dividend 鈫?basis 鈫?capital gain ordering
...
### 馃煛 HIGH PRIORITY - Days 7-12 (Oct 25-30)
...
### 馃煝 MEDIUM PRIORITY - Days 13-15 (Oct 31 - Nov 2)
...
### 鈿?FINAL REVIEW - Days 16-18 (Nov 3-5)
...
1. **Fundamentals** (90 pages)
   - Professional Conduct A.1-A.6 鉁?
   - General Principles B.7-B.16 鉁?

2. **Retirement** (182 pages - MOST COMPREHENSIVE)
   - Retirement Planning F.44-F.53 鉁?
   - All plan types, rules, distributions 鉁?

3. **Tax** (150 pages)
   - Tax Planning E.36-E.43 鉁?
   - Comprehensive coverage 鉁?

4. **Investments** (188 pages)
   - Investment Planning D.27-D.35 鉁?
   - Complete with formulas 鉁?

5. **Insurance** (188 pages)
   - Risk Management C.17-C.26 鉁?
   - All insurance types 鉁?

6. **Estate** (200 pages)
   - Estate Planning G.54-G.64 鉁?
   - Gift/estate/GST tax comprehensive 鉁?

### Materials Needed

鈿狅笍 **Psychology of Financial Planning** (H.65-H.70)
...
- **Capital Market Line (CML)**: **E(Rp) = Rf + [(E(RM) - Rf) / 蟽M] 脳 蟽p**
  - E(Rp) = Expected portfolio return
  - Rf = Risk-free rate
  - E(RM) = Expected market return
  - 蟽M = Market standard deviation
  - 蟽p = Portfolio standard deviation
- **CML Slope** (Market price of risk): **(E(RM) - Rf) / 蟽M**
...
**Installment Sale:**
- **Gross Profit %** = **(Sale Price - Adjusted Basis) 梅 Contract Price**
- **Gain per payment** = Payment 脳 Gross Profit %
...
鉁?**Retirement Planning** - 100% covered, highest-weighted domain (18%) - COMPLETE!
鉁?**Investment Planning** - 100% covered, second-highest domain (17%) - COMPLETE!
鉁?**Tax Planning** - 100% covered, strong calculation skills (14%) - COMPLETE!
鉁?**Insurance** - 100% covered (11%) - COMPLETE!
鉁?**1031 Exchanges** - Perfect understanding, can teach others
鉁?**Medicare** - Comprehensive knowledge after deep dive
鉁?**Quick learner** - Masters calculations once formula understood
鉁?**Strong retention** - Demonstrates across multiple sessions
鉁?**Self-awareness** - Knows when tired, asks for breaks
鉁?**EXCEPTIONAL critical thinking** - Identifies question flaws and imprecise terminology (Oct 29)
鉁?**Professional judgment** - Recognizes CFP should test real-world communication (Oct 29)
鉁?**Excellent analogies** - Creates powerful examples to illustrate points (Oct 29)
...
**Key Rules**:
- 鈿狅笍 Don't study business taxation when tired!
- 鉁?Take breaks every 90 minutes
- 鉁?Practice problems after learning each concept
- 鉁?Review previous day's material each morning
- 鉁?Use slides' exam tips and practice questions
...
| 类别 | 词汇 | 含义 | 用法示例 |
|------|------|------|---------|
| 动词 | Quiero | 我想要/我要 | Quiero agua / Quiero café |
| 饮料 | Agua | 水 | Quiero agua  |
| 饮料 | Café | 咖啡 | Quiero café  |
| 饮料 | Vino | 葡萄酒 | Quiero vino |
| 代词 | Yo | 我 | Yo quiero agua |

###  部分掌握（中等信心）
| 类别 | 词汇 | 含义 | 学习进度 |
|------|------|------|---------|
| 颜色 | Blanco | 白色 | 已学，需巩固 |
| 颜色 | Rojo | 红色 | 初次接触，拼写混淆 |
| 表达 | Lo siento | 我很遗憾 | 学过，理解正确 |
| 短语 | No conozco | 我不知道 | 已学 |
...
**完全掌握**: 14个 | **部分掌握**: 2个 | **待学习**: 0个 (基础词汇已涵盖)

**学习潜力**:  (4/5) - 积极、敢尝试、接受纠正

##  下次会话计划
1. 复习: blanco、rojo 颜色词
2. 新学: cerveza、té 饮料词
3. 练习: 餐厅对话场景
